...
<div class="container">
	  	...
	  	<form name="update_product" class="form-horizontal" action="update_product_process.php" method="post" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="col-sm-3">
					<img onerror="this.src = 'src/image/No_available_image.jpg'" src="src/image/products/<?php echo $image_name?>" id='display_image' class="img-thumbnail" style="width:250px;height:250px">
				...
				<div class="col-sm-9">
				    ...
				    <div class="form-group">
				      	<label>Tax:</label>
				      	<input type="text" class="form-control" value="<?php echo $row['tax'] ?>" name="tax"/>
				    </div>
