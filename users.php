...
<body>
	...
	<?php
		...
		$sql = "SELECT * FROM `users` where `companies_id` = $user_id";
		    ...
		    <?php while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){   ?>
		    	<?php if($row['is_deleted'] == 0):?>
			 	<tr>
			        ...
			        <td><img class="img-thumbnail" onerror="this.src = 'src/image/No_available_image.jpg'" src="src/image/users/<?php echo $row['image_name'] ?>"  width="100" height="100"></td>
...
<div id="Add_quotation_btn">
<a href="quotation.php"><button type="button" class="btn btn-primary btn-md">
     <i class="fas fa-list-ul"></i> Quotation List
</button></a>
</div>
